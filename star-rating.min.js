                ...
                i(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this,
                                ...
                                i = null;
                            this.props.prebuilt &&
                                ((t = this.el.parentNode), (i = t.querySelector('.' + this.props.classNames.base + '--stars'))),
                                null === i &&
                                    ((t = l(this.el, !1, { class: this.props.classNames.base })).appendChild(this.el),
                                    (i = l(this.el, !0, { class: this.props.classNames.base + '--stars' })),
                                    this.values.forEach(function (t, s) {
                                        var n = a({ 'data-index': s, 'data-value': t.value });
                                        'function' == typeof e.props.stars && e.props.stars.call(e, n, t, s),
                                ...
                                t.classList.add(this.props.classNames.base + '--' + this.direction),
                                this.props.tooltip && i.setAttribute('role', 'tooltip'),
                                (this.widgetEl = i);
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return n.parentNode === this.widgetEl
                                ? [].slice.call(n.parentNode.children).indexOf(n)
                                : this.indexActive;
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e,
                                t = this.valueIndex(
                                    null === (e = this.el.querySelector('[selected]')) || void 0 === e ? void 0 : e.value
                                );
            ...
            i(t, [
                {
                    ...
                    value: function () {
                        ...
                        this.queryElements(this.selector).forEach(function (t) {
                            ...
                            'SELECT' !== t.tagName ||
                                t.widget ||
                                (!i.prebuilt && t.parentNode.classList.contains(i.classNames.base) && e.unwrap(t),
